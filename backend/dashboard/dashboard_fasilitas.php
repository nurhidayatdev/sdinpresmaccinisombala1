...
<body class="db">
  ...
  <main id="mainContent">
    ...
    <div class="mt-4">
      <div class="mb-4">
        <h4 class="fw-bold mb-3 text-success">Data Fasilitas Sekolah</h4>

        <?php mysqli_data_seek($result, 0); ?>
        <div class="fasilitas-sekolah">
          <div style="display: flex; justify-content: flex-start; margin-bottom: 12px;">
            <a href="../crud/tambah.php?file=fasilitas_sekolah&tabel=fasilitas_sekolah" class="btn-db btn-add">
                ...
                while ($row = mysqli_fetch_assoc($result)) : ?>
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="../crud/edit.php?file=fasilitas&tabel=fasilitas_sekolah&id=<?= $row['id']; ?>" class="btn-db  btn-edit"><i data-lucide="square-pen"></i></a>
