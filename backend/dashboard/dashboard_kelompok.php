...
<body class="db">
  ...
  <main id="mainContent">
    ...
    <div class="content mt-4">
      <div class="mb-4">
        <h4 class="fw-bold mb-3 text-success">Anggota Kelompok</h4>

        <?php mysqli_data_seek($result, 0); ?>
        <div class="fasilitas-sekolah">
          <div style="display: flex; justify-content: flex-start; margin-bottom: 12px;">
            <a href="../crud/tambah.php?file=kelompok&tabel=kelompok" class="btn-db btn-add">
                ...
                while ($row = mysqli_fetch_assoc($result)) : ?>
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="../crud/edit.php?file=kelompok&tabel=kelompok&id=<?= $row['id']; ?>" class="btn-db btn-edit mx-2 my-2"><i data-lucide="square-pen"></i></a>
