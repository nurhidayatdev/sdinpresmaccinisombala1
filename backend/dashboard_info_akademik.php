...
<body>
    ...
    <nav class="sidebar" id="sidebarMenu">
        ...
        <ul class="nav flex-column mt-3">
            ...
            <li><a class="nav-link active" href="#"><i data-lucide="graduation-cap"></i> Info Akademik</a></li>
                                ...
                                <?php while ($data_mengajar = mysqli_fetch_assoc($result_mengajar)) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="edit.php?file=info-akademik&tabel=mengajar&id=<?= $data_mengajar['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                            ...
                            <tbody>
                                <?php while ($data_pembina = mysqli_fetch_assoc($result_pembina)) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="edit.php?file=info-akademik&tabel=pembina_kegiatan&id=<?= $data_mengajar['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
