        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-6">
                    <h3 class="fw-bold mb-3" style="color: #f8ae84">Kontak Sekolah</h3>
                    <p class="mb-1">
                        <strong>Email:</strong>
                        <a href="mailto:sdimacsombala1@gmail.com" class="text-decoration-none" style="color: #fffccf">
            ...
            <hr style="border-color: #f8ae84; width: 60%; margin: 15px auto" />
            <p class="mb-0">
                <a href="../index.html" class="text-white text-decoration-none">&copy; 2025 SD Inpres Maccini Sombala 1</a>
            </p>
        </div>
    </footer>
    </body>
