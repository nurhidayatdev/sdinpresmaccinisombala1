            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="info-akademik.html">Info Akademik</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="#">Fasilitas Sekolah</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="berita.html">Berita & Pengumuman</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="info-akademik.html">Tentang Kami</a>
                        </li>
                        <li class="nav-item">
