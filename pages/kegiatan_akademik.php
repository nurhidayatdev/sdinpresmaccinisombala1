                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu custom-dropdown" aria-labelledby="infoAkademikDropdown">
                                <li><a class="dropdown-item active" href="#"><i data-lucide="calendar-check"></i> Kegiatan Akademik</a></li>
            ...
            <div class="row g-4 justify-content-between">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <ul class="footer-menu">
                        ...
                        <li><a href="#"><i data-lucide="calendar-check"></i> Kegiatan Akademik</a></li>
